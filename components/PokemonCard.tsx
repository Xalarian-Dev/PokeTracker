...
const gameColorMap: Record<string, { keys: [string, string]; colors: [string, string] }> = {
    ...
    'gs':   { keys: ['g', 's'],    colors: ['bg-yellow-800/50', 'bg-slate-500/50'] },
    ...
    'hgss': { keys: ['hg', 'ss'],  colors: ['bg-yellow-800/50', 'bg-slate-500/50'] },
    ...
    'sm':   { keys: ['su', 'm'],   colors: ['bg-orange-800/50', 'bg-indigo-800/50'] },
    'usum': { keys: ['usu', 'um'], colors: ['bg-orange-800/50', 'bg-indigo-800/50'] },
