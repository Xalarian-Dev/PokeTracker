...
export const ui = {
    ...
    regional_forms_alola: "アローラのすがた",
    regional_forms_galar: "ガラルのすがた",
    regional_forms_hisui: "ヒスイのすがた",
    regional_forms_paldea: "パルデアのすがた",
    shiny_lock: "色違いロック",
    friendSafari: "フレンドサファリ",
    islandScan: '島スキャン',
    ...
    filters: "フィルター",
    random_hunt: "ランダムハント",
    random_hunt_description: "運命に次の色違い狩りを決めてもらおう！",
    roll: "ロール",
    rolling: "ロール中...",
