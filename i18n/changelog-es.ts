...
export const changelogES: ChangeLogEntry = {
    ...
    sectionTitle: "Renovación Móvil, Filtro DLC y Rendimiento",
    ...
    technicalList: [
        ...
        "El selector de idioma en el perfil ahora se adapta en pantallas pequeñas en lugar de desbordarse",
