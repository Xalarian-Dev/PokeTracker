...
for line in lines:
    ...
    for id in ids_list:
        if stripped.startswith(f"'{id}': ["):
            # Found a match
            if "'us'" not in line and "'um'" not in line:
                if stripped.endswith("[],"):
                     line = line.replace("[],", "['us', 'um'],")
                else:
                     line = line.replace("],", ", 'us', 'um'],")
                matched = True
                break
